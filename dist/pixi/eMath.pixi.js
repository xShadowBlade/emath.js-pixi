(function (g, f) {
    ...
    if (typeof define === "function" && define.amd) {
      define(['reflect-metadata', 'class-transformer', 'pixi.js'], f);
    } else if (typeof module === "object" && module.exports) {
      module.exports = f(require('reflect-metadata'), require('class-transformer'), require('pixi.js'));
    } else {
      var m = hasExports ? f(require('reflect-metadata'), require('class-transformer'), require('pixi.js')) : f(g["reflect-metadata"], g["class-transformer"], g["pixi.js"]);
...
// node_modules/emath.js/dist/game/eMath.game.mjs
...
emath.js/dist/game/eMath.game.mjs:
  (*! Bundled license information:
